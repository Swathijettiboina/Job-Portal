...
// const { createClient } = require('@supabase/supabase-js');
// const supabaseCilent=require('../db/supabase')

// const SECRET_KEY = process.env.JWT_SECRET || "your_secret_key"; // Use environment variables
...
//     // Generate JWT Token
//     const token = jwt.sign({ id: data.id, email: data.email, userType }, SECRET_KEY, {
